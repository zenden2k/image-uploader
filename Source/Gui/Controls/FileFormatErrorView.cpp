...
LRESULT CFileFormatErrorView::OnGetDispInfo(int idCtrl, LPNMHDR pnmh, BOOL& bHandled) {
...
LRESULT CFileFormatErrorView::OnListViewNMCustomDraw(int idCtrl, LPNMHDR pnmh, BOOL& bHandled)
{
...
void CFileFormatErrorView::onRowChanged(size_t index) {
