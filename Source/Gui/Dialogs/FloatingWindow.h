...
#define IDM_OPENSCREENSHOTSFOLDER (IDM_REUPLOADIMAGES+27)
#define IDM_SHOWLASTUPLOADRESULTS (IDM_REUPLOADIMAGES+28)
#define IDM_MONITOR_ALLMONITORS (IDM_REUPLOADIMAGES+29)
#define IDM_MONITOR_CURRENTMONITOR (IDM_REUPLOADIMAGES+30)
#define IDM_QUICKUPLOADFROMCLIPBOARD (IDM_UPLOADFILES+31)
#define IDM_LASTREGIONSCREENSHOT (IDM_UPLOADFILES+32)
#define IDM_MONITOR_SELECTEDMONITOR_FIRST (IDM_REUPLOADIMAGES+50)
#define IDM_MONITOR_SELECTEDMONITOR_LAST (IDM_REUPLOADIMAGES+50+25)
