...
bool ImageConverter::createThumbnail(AbstractImage* image, AbstractImage** outResult, int64_t fileSize, int fileformat)
{
    Q_D(ImageConverter);
    return d->createThumbnail(image, outResult, fileSize, fileformat);
}
