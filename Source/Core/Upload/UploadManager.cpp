...
UploadManager::UploadManager(std::shared_ptr<UploadEngineManager> uploadEngineManager, CUploadEngineList* engineList, std::shared_ptr<ScriptsManager> scriptsManager,
