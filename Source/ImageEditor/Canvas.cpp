...
std::shared_ptr<InputBox> Canvas::getInputBox( const RECT& rect ) {
    ...
    /*HWND wnd =*/ inputBox_->Create( parentWindow_, rc, WS_CHILD |ES_MULTILINE|/*ES_AUTOHSCROLL|*/ES_AUTOVSCROLL|  ES_WANTRETURN | ES_NOHIDESEL /*| ES_LEFT */, /* WS_EX_TRANSPARENT |*/ rtlStyle);
